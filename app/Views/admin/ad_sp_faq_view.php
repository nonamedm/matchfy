    ...
    <div class="ad_box">
        ...
        <div class="ad_con">
            ...
            <div class="btn_up_del_box">
                <input type="button" value="수정" Onclick="fn_clickUpdate('spfaq','<?= $faq['id']?>')"/>
                <input type="button" value="<?=lang('Korean.delete')?>"  Onclick="fn_clickDelete('<?= $faq['id']?>','spfaq')"/>
            </div>

    ...
    <div class="ad_box">
        ...
        <div class="ad_con">
            ...
            <form action="/ad/intro/newsUpdate" method="post">
                ...
                <div class="label_input_text" id="media_link" style="display:<?php if ($news['bigo1'] == "01"){ echo 'block'; }else{echo 'none';};?>;">
                    <label for="link">링크</label>
                    <input type="text" class="temp_input_text" id="link" name="bigo2" value="<?= $news['bigo2'] ?>">
                </div>
                <div class="label_input_text" id="media_content" style="display:<?php if ($news['bigo1'] == "02"){ echo 'block'; }else{echo 'none';};?>;">

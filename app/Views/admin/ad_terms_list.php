...
<body>
    <div class="ad_box">
        ...
        <div class="ad_con">
            <h2>이용약관 목록</h2> 
            <input class="edit btn type01" type="button" value="등록" Onclick="fn_EditClick('terms');"/><br>
            <table>
                <thead>
                    <tr class="tr">
                ...
                <tbody>
                    <?php foreach ($termss as $terms): ?>
                        <tr class="tr">
                            ...
                            <td class="td">
                                <input type="button" class="btn type02" value="삭제"  Onclick="fn_clickDelete('<?= $terms['id']?>','terms')"/>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>

                ...
                <form class="main_signin_form" method="post" action="/mo/signinPhoto" enctype="multipart/form-data">
                    <div class="form_row signin_form">
                        <div class="signin_form_div">
                            <label for="email" class="signin_label">서포터즈 로그인<?= lang('Korean.email') ?></label>
                    ...
                    <div class="btn_group multy">
                        <button type="button" class="btn type02" onclick="moveToUrl('/support/mo')"><?= lang('Korean.cancel') ?></button>
                        <button type="button" class="btn type01" onclick="supportPasswdUpdate()">비밀번호 재설정</button>
                    </div>
            </div>
            </form>
        </div>

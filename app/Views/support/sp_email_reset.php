                ...
                <form class="main_signin_form" method="post" action="/mo/signinPhoto" enctype="multipart/form-data">
                    <div class="form_row signin_form">
                        <div class="signin_form_div">
                            <label for="email" class="signin_label"><?= lang('Korean.login') ?> <?= lang('Korean.email') ?></label>
                    ...
                    <div class="btn_group multy">
                        <button type="button" class="btn type02">서포터즈 <?= lang('Korean.login') ?></button>
                        <button type="button" class="btn type01" onclick="moveUrl('/support/mo')">비밀번호 재설정하러가기</button>
                    </div>
            </div>
            </form>
        </div>

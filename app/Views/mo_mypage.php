                ...
                <div class="line_banner">
                    <a href="#">
                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M0 6C0 2.68629 2.68629 0 6 0H14C17.3137 0 20 2.68629 20 6V10C20 13.3137 17.3137 16 14 16H0V6Z"
                                fill="white" />
                    ...
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.65685 1.34315L10.3137 7L4.65685 12.6569" stroke="white" stroke-width="1.5"
                    ...
                    <ul>
                        <li onclick="moveToUrl('/mo/mypage/wallet')">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                ...
                                <path
                                    ...
                                    fill="white" stroke="#111111" stroke-width="1.5" stroke-linejoin="bevel" />
                                <path d="M5 6L6.99681 13L9 6L10.9968 13L13 6" fill="white" />
                                <path d="M5 6L6.99681 13L9 6L10.9968 13L13 6" stroke="#111111" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M4 8H14" stroke="#111111" stroke-width="1.5" stroke-linecap="round"
                        ...
                        <li onclick="moveToUrl('/mo/mypage/mygroup/list')">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M15.3001 16.2001V13.5001C15.3001 11.5119 13.6883 9.90015 11.7001 9.90015H6.30007C4.31185 9.90015 2.70007 11.5119 2.70007 13.5001V16.2001"

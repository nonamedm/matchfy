                            ...
                            <div class="signin_form_div">
                                ...
                                <div class="multy_select">
                                    ...
                                    <select id="father_job" name="father_job" class="custom_select" value="">
                                        <option value=""><?=lang('Korean.selected')?></option>
                                        <option value="0" <?= $father_job === '0' ? 'selected' : '' ?>><?=lang('Korean.employee')?></option>
                                        <option value="1" <?= $father_job === '1' ? 'selected' : '' ?>><?=lang('Korean.entrepreneur')?></option>
                                        <option value="2" <?= $father_job === '2' ? 'selected' : '' ?>><?=lang('Korean.selfEmployment')?></option>
                                        <option value="3" <?= $father_job === '3' ? 'selected' : '' ?>><?=lang('Korean.inoccupation')?></option>
                                        <option value="4" <?= $father_job === '4' ? 'selected' : '' ?>><?=lang('Korean.extra')?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="signin_form_div">
                                ...
                                <div class="multy_select">
                                    ...
                                    <select id="mother_job" name="mother_job" class="custom_select" value="">
                                        <option value=""><?=lang('Korean.selected')?></option>
                                        <option value="0" <?= $mother_job === '0' ? 'selected' : '' ?>><?=lang('Korean.employee')?></option>
                                        <option value="1" <?= $mother_job === '1' ? 'selected' : '' ?>><?=lang('Korean.entrepreneur')?></option>
                                        <option value="2" <?= $mother_job === '2' ? 'selected' : '' ?>><?=lang('Korean.selfEmployment')?></option>
                                        <option value="3" <?= $mother_job === '3' ? 'selected' : '' ?>><?=lang('Korean.housewife')?></option>
                                        <option value="4" <?= $mother_job === '4' ? 'selected' : '' ?>><?=lang('Korean.extra')?></option>
                                    </select>
                                </div>
                            </div>
                        </div>

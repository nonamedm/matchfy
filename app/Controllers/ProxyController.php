...
class ProxyController extends BaseController
{
    ...
    public function createSupportPassWeb()
    {
        ...
        $enc_result_val = base64_encode($resultVal);
        $reqData = ["returnurl" => "https://matchfy.net/support/proxy/getResultValue?nickname=" . $nickname . "&sns_type=" . $sns_type . "&oauth_id=" . $oauth_id . "&ci1=" . $enc_result_val, "sitecode" => $siteCode, "popupyn" => "Y", "mobilceco" => "S", 'methodtype' => 'get'];

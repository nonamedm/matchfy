...
class ProxyController extends BaseController
{
    ...
    public function idpwFind()
    {
        ...
        $enc_result_val = base64_encode($resultVal);
        $reqData = ["returnurl" => "https://matchfy.net/proxy/getResultIdpwValue?nickname=" . $nickname . "&sns_type=" . $sns_type . "&oauth_id=" . $oauth_id . "&ci1=" . $enc_result_val, "sitecode" => $siteCode, "popupyn" => "Y", "mobilceco" => "S", 'methodtype' => 'get'];
    ...
    public function getResultIdpwValue()
    {
        $resultVal = base64_decode($this->request->getGet('ci1') . "");
    ...
    /* 서포터즈 */
    public function createSupportPassWeb()
    {
        // API URL
        $url = 'https://svc.niceapi.co.kr:22001/digital/niceid/api/v1.0/common/crypto/token';
        $currentTimestamp = time();
        ...
        $enc_result_val = base64_encode($resultVal);
        $reqData = ["returnurl" => "https://matchfy.net/support/proxy/getSupportResultValue?nickname=" . $nickname . "&sns_type=" . $sns_type . "&oauth_id=" . $oauth_id . "&ci1=" . $enc_result_val, "sitecode" => $siteCode, "popupyn" => "Y", "mobilceco" => "S", 'methodtype' => 'get'];
    ...
    public function getSupportResultValue()
    {
        $resultVal = base64_decode($this->request->getGet('ci1') . "");
        ...
        $BoardModel = new SupportBoardModel();
        $BoardModel->setTableName('wh_support_board_terms');
        $postData['terms'] = $BoardModel->orderBy('created_at', 'DESC')->first();

        $BoardModel2 = new SupportBoardModel();
        $BoardModel2->setTableName('wh_support_board_privacy');
        $postData['privacy'] = $BoardModel2->orderBy('created_at', 'DESC')->first();
    ...
    public function spIdPwFind()
    {
        ...
        $enc_result_val = base64_encode($resultVal);
        $reqData = ["returnurl" => "https://matchfy.net/support/proxy/getResultSupportIdpwValue?nickname=" . $nickname . "&sns_type=" . $sns_type . "&oauth_id=" . $oauth_id . "&ci1=" . $enc_result_val, "sitecode" => $siteCode, "popupyn" => "Y", "mobilceco" => "S", 'methodtype' => 'get'];
    ...
    public function getResultSupportIdpwValue()
    {
        $resultVal = base64_decode($this->request->getGet('ci1') . "");
